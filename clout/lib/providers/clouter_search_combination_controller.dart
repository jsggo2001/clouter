...
// 필요한 controller들
  ...
  var clouterInfiniteController;
// 필요한 controller들 실행시키는 메소드
  runOtherControllers() {
    searchDetailController = Get.put(SearchDetailController());
    clouterInfiniteController =
        Get.find<ClouterInfiniteScrollController>(tag: controllerTag);
  }
  ...
  fetchSearchResults() {
    ...
    clouterInfiniteController.setParameter(requestUrl);
    clouterInfiniteController.reload();
  }
